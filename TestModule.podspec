...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/GE-GAO-ZHAO/Test.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gegaozhao1126@gmail.com' => 'gegaozhao1126@gmail.com' }
  s.source           = { :git => 'https://github.com/GE-GAO-ZHAO/Test.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'TestModule/Classes/Core/*'
